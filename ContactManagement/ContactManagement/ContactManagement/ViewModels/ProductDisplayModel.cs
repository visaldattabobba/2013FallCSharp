...
namespace ContactManagement.ViewModels
{
    public class ProductDisplayModel : INotifyPropertyChanged
    {
        ...
        {
            get { return searchCommand ?? (searchCommand = new RelayCommand(() => SearchProductDisplay()/*, ()=>isSelected*/)); }
        }
        ...
        private void UpdateProduct()
        {
            ...
            if (!App.StoreEntity.UpdateProduct(DisplayedProduct, DisplayedProduct._ContactId))
            {
                stat.Status = App.StoreEntity.errorMessage;
                return;
            }
        ...
        {
            if (!App.StoreEntity.DeleteProduct(DisplayedProduct._ContactId ))
            {
                stat.Status = App.StoreEntity.errorMessage;
                return;
            }
        ...
        private void AddProduct()
        {
            ...
            if (!App.StoreEntity.AddProduct(DisplayedProduct))
            {
                stat.Status = App.StoreEntity.errorMessage;
                return;
            }
